(function ($) {
   ...
   var roles = [
    ...
    // Add any other roles you want to rotate through here
];
var roleIndex = 0;
var roleElement = document.getElementById('role');

function changeRole() {
    // Push out current role
    roleElement.style.animation = 'push-out 0.5s ease';
    setTimeout(function () {
        // Change role
        ...
        // Push in new role
        roleElement.style.animation = 'push-in 0.5s ease';
        setTimeout(changeRole, 2500);  // Schedule next change
    }, 500);  // Wait for push-out animation to finish
}

// Delay initial role change
setTimeout(changeRole, 5000); // 5000 milliseconds = 5 seconds
